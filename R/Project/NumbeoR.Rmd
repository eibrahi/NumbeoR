...
The data structure of the analysis dataframe is:
```{r echo=FALSE}
glimpse(df_analysis)
```
...
df_analysis <- df_analysis %>% 
  mutate(MortgageAsAPercentageOfIncome = ifelse(MortgageAsAPercentageOfIncome>2000, NA, MortgageAsAPercentageOfIncome))
...
The new structure of the clean dataframe is:
```{r echo=FALSE}
...
It is an issue on how this topic is handelded in the **media**.  
And here the **politicians** and the **media** have room for improvement.
