...
### CO2 Emission  vs. Local Purchasing Power
...
write.csv(df_analysis_clean,"C:/Users/sveti/Desktop/Diverses/GitProjects/NumbeoR/daten/CleanDF.csv", row.names = FALSE)
```
...
---
Correlation Anzahl Flüchtlinge

```{r}
asylumSeekerGer <- read.csv(file="C:/Users/sveti/Desktop/Diverses/GitProjects/NumbeoR/daten/asylum_seeker_Germany.csv",header=TRUE, sep=";")
colnames(asylumSeekerGer) <- c("Year", "AsylumSeekerGermany", "AsylumSeekerGermanyCum")
```
see [statista](https://de.statista.com/statistik/daten/studie/76095/umfrage/asylantraege-insgesamt-in-deutschland-seit-1995/)
--- 
...
---
Correlation tatsächliche Krim

```{r}
numberCrimesGer <- read.csv(file="C:/Users/sveti/Desktop/Diverses/GitProjects/NumbeoR/daten/crimeStatisticsGermany.csv",header=TRUE, sep=";")
colnames(numberCrimesGer) <- c("Year", "number_crimes")
```
see [statista](https://de.statista.com/statistik/daten/studie/197/umfrage/straftaten-in-deutschland-seit-1997/)
--- 
