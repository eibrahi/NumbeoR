...
corrplot(cor(df_analysis_numeric), method="color", col=col(200),  
...
The Cost of Living Index is a dependent variable of the Rent Index and the Local Purchasing Power Index.

But we see that the Pollution Index could be negatively correlated with the Local Purchasing Power Index and the Cost of Living Index. 
...
Here, we show the correlation of two variables 
```{r}
